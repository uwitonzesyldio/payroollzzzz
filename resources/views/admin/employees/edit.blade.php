            ...
            <div class="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                <div class="bg-gradient-to-r from-amber-500 to-orange-600 px-8 py-5">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            <h3 class="text-white font-semibold text-lg">Edit Staff Record</h3>
                            <p class="text-amber-100 text-sm">Update team member information</p>
                        </div>
                    </div>
                </div>

                <form action="{{ route('admin.employees.update', $employee) }}" method="POST" class="p-8">
                    @csrf @method('PATCH')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name', $employee->name) }}" class="w-full rounded-xl border-2 border-gray-200 shadow-sm focus:border-amber-500 focus:ring-amber-500 @error('name') border-red-400 @enderror px-4 py-3 transition duration-150">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <div class="relative">
                                ...
                                <input type="number" step="0.01" name="salary" id="salary" value="{{ old('salary', $employee->salary) }}" class="w-full rounded-xl border-2 border-gray-200 shadow-sm focus:border-amber-500 focus:ring-amber-500 @error('salary') border-red-400 @enderror px-4 py-3 pl-8 transition duration-150">
                            </div>
